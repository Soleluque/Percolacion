...
{ printf("Me cago en vos\n");
  ...
  printf("Me cago en vos00\n");

  p_c = malloc(6*sizeof(float));
  dims = malloc(7*sizeof(int));
  n_sn = malloc(sizeof("scaling_000.txt"));
  //n_s = malloc(sizeof("gamma_00000_dim_000.txt"));
...
printf("Me cago en todos ustedes\n");

      for(t=0;t<dim*dim;t++)
      { printf("Me cago en vos c, python y la concha de tu hermana\n");
         sprintf(n_sn,"scaling_%i",t);
         printf("Ojala te mueras\n");
         n_s = fopen(n_sn, "a");
         printf("Que cristo jesus te tenga en su gloria\n");
         fprintf(n_s,"%f %f\n", p, *(ns_p+t));
         printf("Y lucy te ame\n");
         fclose(n_s);
         printf("Amen\n");
      }
      printf("Te odio, forro de mierda\n");
